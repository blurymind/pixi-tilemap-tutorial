  ...
  var CompositeRectTileLayer = (function(_super) {
    ...
    CompositeRectTileLayer.prototype.addRect = function(
      ...
      if (this.children[childIndex] && this.children[childIndex].textures) {
        this.children[childIndex].addRect(
          textureId,
          u,
          v,
          x,
...
(function(pixi_tilemap) {
  var GraphicsLayer = (function(_super) {
    ...
    GraphicsLayer.prototype.renderWebGL = function(renderer) {
      if (!this._webGL[renderer.CONTEXT_UID]) this.dirty++;
      ...
      for (
        ...
        if (textureIndex >= 0) {
          renderer.context.drawImage(
            this.textures[textureIndex].baseTexture.source,
            x1,
            y1,
            w,
            h,
      ...
      if (this.modificationMarker !== vertices) {
        ...
        for (
          ...
          var animX = points[i + 7],
            animY = points[i + 8];
          var animWidth = points[i + 10],
            animHeight = points[i + 11];
          var u0 = void 0,
            v0 = void 0,
            u1 = void 0,
            v1 = void 0,
...
(function(pixi_tilemap) {
  ...
  var RectTileShader = (function(_super) {
    ...
    function RectTileShader(gl, maxTextures) {
      ...
      _this.vertSize = pixi_tilemap.POINT_STRUCT_SIZE + 1;
      _this.vertPerQuad = 4;
    ...
    TileRenderer.prototype.initBounds = function() {
      ...
      for (var i = 0; i < maxTextures; i++) {
        var rt = PIXI.RenderTexture.create(
          pixi_tilemap.Constant.bufferSize,
          pixi_tilemap.Constant.bufferSize
        );
        ...
        if (!bs.texture || bs.texture.baseTexture !== texture.baseTexture) {
          ...
          if (doClear) {
            _hackSubImage(
              ...
              bs,
              this._clearBuffer,
              pixi_tilemap.Constant.boundSize,
              pixi_tilemap.Constant.boundSize
            );
          } else {
            _hackSubImage(
...
(function(pixi_tilemap) {
  var SimpleTileRenderer = (function(_super) {
    ...
    SimpleTileRenderer.prototype.bindTextures = function(
      renderer,
      shader,
      textures
    ) {
